...
Resumidamente, o PRM constrói um grafo G(V,A) em que V é o conjunto de vértices, que são os pontos livres encontrados aleatoriamente no mapa, e o conjunto A são as arestas que ligam os vértices vizinhos que não possuem obstáculos entre eles.
