...
<!-- ## Introdução -->
O uso de veículos aéreos não tripulados (VANT's), amplamente conhecidos como drones (do inglês, zumbido), tem se popularizado em diversas áreas, tanto para aplicações civis quanto para aplicações militares. Por não necessitar da presença de um piloto embarcado, muitas operações arriscadas ou de difícil acesso podem ser executadas por esse tipo de veículo, como busca e resgate, vigilância e mapeamento. Em aplicações civis, os VANT's tem sido utilizados na agricultura (na distribuição de defensivos e monitoramento), na cinematografia, entretenimento, foco de estudos acadêmicos (pela sua complexidade e vastas aplicações), entre outros. Em janeiro de 2022, a Agência Nacional de Aviação Civil [(ANAC)](https://www.gov.br/anac/pt-br/noticias/2022/anac-concede-a-primeira-autorizacao-para-entregas-comerciais-com-drone) concedeu a autorização do primeiro multirrotor a realizar entregas comerciais no Brasil. Muitas dessas tarefas tem a necessidade da implementação de autonomia nesse tipo de veículo. Nesse contexto, se iniciou o desenvolvimento do projeto Carcara, que envolve a concepção de um VANT do tipo quadrotor e a implementação da autonomia nele. O principal objetivo desse projeto é realizar o pouso autônomo dessa veículo em uma plataforma móvel, já que um dos grandes desafios do uso de drones é a sua baixa autonomia (tempo de vôo) e pode existir a necessidade dessa operação para ser realizada uma possível recarga da bateria. O veículo móvel que será usado para a realização do pouso é uma caminhonete modelo L200.
...
<center>
  <img src="{{ 'assets/img/carcara/exploded_with_transcription-white.png' | relative_url }}" width="750" text-align=center alt="img1" />
</center>
